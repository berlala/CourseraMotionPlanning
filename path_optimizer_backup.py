...
class PathOptimizer:
    ...
    def solve_spiral_equation(self, xf, yf, tf):
        ...
        def f(X):
            ...
            return [a3*sf**3 + a2*sf**2 + a1*sf,    # theta(0) = 0
                    a3*sf**4/4 + a2*sf**3/3 + a1*sf**2/2,  # theta(sf) = 0
                    sf/24*(  cos(0) +  \
        ...
        spiral = self.sample_spiral_parameters(result)
        return spiral
    ...
    def thetaf(self, a, b, c, d, s):
        ...
        thetas.append(a*s + b*s*s/2.0 + c*s*s*s/3.0 + d*s*s*s*s/4.0)
        return thetas
        # ------------------------------------------------------------------
    ...
    def sample_spiral_parameters(self, result_parameters):
        ...
        a = 0
        b = result_parameters[1]
        c = result_parameters[2]
        d = result_parameters[3]
        sf = result_parameters[4]
